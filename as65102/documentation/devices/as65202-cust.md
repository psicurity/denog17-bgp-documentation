...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.108/24 | 172.100.100.1 |

##### IPv6

| Management Interface | Description | Type | VRF | IPv6 Address | IPv6 Gateway |
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 2001:172:100:100::108/80 | - |
...
interface Management1
   ...
   ipv6 enable
   ipv6 address 2001:172:100:100::108/80
   no lldp transmit
   no lldp receive
```
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_as65102-3_Ethernet3 | - | 10.102.0.15/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_IXP_Ethernet1 | - | 10.10.0.202/24 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_as65102-3_Ethernet3
   no shutdown
   mtu 1500
   no switchport
   ip address 10.102.0.15/31
!
interface Ethernet2
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.202.2.1/32 |

##### IPv6

| Interface | Description | VRF | IPv6 Address |
| --------- | ----------- | --- | ------------ |
| Loopback0 | ROUTER_ID | default | 2001:db8:202::1/128 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.202.2.1/32
   ipv6 address 2001:db8:202::1/128
```
