...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.105/24 | 172.100.100.1 |

##### IPv6

| Management Interface | Description | Type | VRF | IPv6 Address | IPv6 Gateway |
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 2001:172:100:100::105/80 | - |
...
interface Management1
   ...
   ipv6 enable
   ipv6 address 2001:172:100:100::105/80
   no lldp transmit
   no lldp receive
```
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_as65102-2_Ethernet1 | - | 10.102.0.0/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_as65102-3_Ethernet1 | - | 10.102.0.2/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_CORE1_Ethernet5 | - | 10.0.0.3/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_CORE2_Ethernet25 | - | 10.1.0.31/31 | default | 1500 | False | - | - |

##### IPv6

| Interface | Description | Channel Group | IPv6 Address | VRF | MTU | Shutdown | ND RA Disabled | Managed Config Flag | IPv6 ACL In | IPv6 ACL Out |
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_as65102-2_Ethernet1 | - | - | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_as65102-3_Ethernet1 | - | - | default | 1500 | False | - | - | - | - |
| Ethernet3 | P2P_CORE1_Ethernet5 | - | 2001:db8:0:0:102::1/127 | default | 1500 | False | - | - | - | - |
| Ethernet4 | P2P_CORE2_Ethernet25 | - | 2001:db8:1:0:102:1::1/127 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_as65102-2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.102.0.0/31
   ipv6 enable
   mpls ip
   isis enable CORE
...
!
interface Ethernet2
   description P2P_as65102-3_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.102.0.2/31
   ipv6 enable
   mpls ip
   isis enable CORE
   isis circuit-type level-2
...
interface Ethernet3
   ...
   ipv6 address 2001:db8:0:0:102::1/127
!
interface Ethernet4
   ...
   ipv6 address 2001:db8:1:0:102:1::1/127
```
...
| --------- | ----------- | --- | ------------ |
| Loopback0 | ROUTER_ID | default | 2001:db8:102::1/128 |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0101.0200.1001.00 |
| Type | level-2 |
...
!
router isis CORE
   net 49.0001.0101.0200.1001.00
   router-id ipv4 10.102.1.1
   is-type level-2
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.102.1.2 | Inherited from peer group MPLS-OVERLAY-PEERS | default | - | Inherited from peer group MPLS-OVERLAY-PEERS | Inherited from peer group MPLS-OVERLAY-PEERS | - | Inherited from peer group MPLS-OVERLAY-PEERS | - | - | - | - |
| 10.102.1.3 | Inherited from peer group MPLS-OVERLAY-PEERS | default | - | Inherited from peer group MPLS-OVERLAY-PEERS | Inherited from peer group MPLS-OVERLAY-PEERS | - | Inherited from peer group MPLS-OVERLAY-PEERS | - | - | - | - |
...
router bgp 65102
   ...
   neighbor MPLS-OVERLAY-PEERS remote-as 65102
   neighbor MPLS-OVERLAY-PEERS update-source Loopback0
   neighbor MPLS-OVERLAY-PEERS bfd
   neighbor MPLS-OVERLAY-PEERS password 7 <removed>
   neighbor MPLS-OVERLAY-PEERS send-community
   neighbor MPLS-OVERLAY-PEERS maximum-routes 0
   neighbor 10.102.1.2 peer group MPLS-OVERLAY-PEERS
   neighbor 10.102.1.2 description as65102-2_Loopback0
   neighbor 10.102.1.3 peer group MPLS-OVERLAY-PEERS
   neighbor 10.102.1.3 description as65102-3_Loopback0
   !
   address-family ipv4
