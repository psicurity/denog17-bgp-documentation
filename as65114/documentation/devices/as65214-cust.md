...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.156/24 | 172.100.100.1 |

##### IPv6

| Management Interface | Description | Type | VRF | IPv6 Address | IPv6 Gateway |
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 2001:172:100:100::156/24 | - |
...
interface Management1
   ...
   no shutdown
   vrf MGMT
   ip address 172.100.100.156/24
   ipv6 enable
   ipv6 address 2001:172:100:100::156/24
   no lldp transmit
   no lldp receive
```
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_as65114-3_Ethernet3 | - | 10.114.0.15/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_IXP_Ethernet1 | - | 10.10.0.214/24 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_as65114-3_Ethernet3
   no shutdown
   mtu 1500
   no switchport
   ip address 10.114.0.15/31
!
interface Ethernet2
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.214.2.1/32 |
