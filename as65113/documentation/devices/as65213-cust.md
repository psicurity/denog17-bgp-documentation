...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.152/24 | 172.100.100.1 |

##### IPv6

| Management Interface | Description | Type | VRF | IPv6 Address | IPv6 Gateway |
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 2001:172:100:100::152/80 | - |
...
interface Management1
   ...
   no shutdown
   vrf MGMT
   ip address 172.100.100.152/24
   ipv6 enable
   ipv6 address 2001:172:100:100::152/80
   no lldp transmit
   no lldp receive
```
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_as65113-3_Ethernet3 | - | 10.113.0.15/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_IXP_Ethernet1 | - | 10.10.0.213/24 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_as65113-3_Ethernet3
   no shutdown
   mtu 1500
   no switchport
   ip address 10.113.0.15/31
!
interface Ethernet2
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.213.2.1/32 |

##### IPv6

| Interface | Description | VRF | IPv6 Address |
| --------- | ----------- | --- | ------------ |
| Loopback0 | ROUTER_ID | default | 2001:db8:213::1/128 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.213.2.1/32
   ipv6 address 2001:db8:213::1/128
```
