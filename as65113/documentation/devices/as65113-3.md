...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.151/24 | 172.100.100.1 |

##### IPv6

| Management Interface | Description | Type | VRF | IPv6 Address | IPv6 Gateway |
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 2001:172:100:100::151/80 | - |
...
interface Management1
   ...
   ipv6 enable
   ipv6 address 2001:172:100:100::151/80
   no lldp transmit
   no lldp receive
```
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_as65113-1_Ethernet2 | - | 10.113.0.3/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_as65113-2_Ethernet2 | - | 10.113.0.5/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_as65113-cust_Ethernet1 | - | 10.113.0.14/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_IXP_Ethernet8 | - | 10.10.0.113/24 | default | 1500 | False | - | - |

##### IPv6

| Interface | Description | Channel Group | IPv6 Address | VRF | MTU | Shutdown | ND RA Disabled | Managed Config Flag | IPv6 ACL In | IPv6 ACL Out |
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_as65113-1_Ethernet2 | - | - | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_as65113-2_Ethernet2 | - | - | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_as65113-1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 10.113.0.3/31
   ipv6 enable
   mpls ip
   isis enable CORE
...
!
interface Ethernet2
   description P2P_as65113-2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 10.113.0.5/31
   ipv6 enable
   mpls ip
   isis enable CORE
   isis circuit-type level-2
...
!
interface Ethernet3
   description P2P_as65113-cust_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.113.0.14/31
!
interface Ethernet4
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.113.1.3/32 |

##### IPv6

| Interface | Description | VRF | IPv6 Address |
| --------- | ----------- | --- | ------------ |
| Loopback0 | ROUTER_ID | default | 2001:db8:113::3/128 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.113.1.3/32
   ipv6 address 2001:db8:113::3/128
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0101.1300.1003.00 |
| Type | level-2 |
| Router-ID | 10.113.1.3 |
...
!
router isis CORE
   net 49.0001.0101.1300.1003.00
   router-id ipv4 10.113.1.3
   is-type level-2
