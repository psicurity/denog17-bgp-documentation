...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.141/24 | 172.100.100.1 |

##### IPv6

| Management Interface | Description | Type | VRF | IPv6 Address | IPv6 Gateway |
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 2001:172:100:100::141/80 | - |
...
interface Management1
   ...
   no shutdown
   vrf MGMT
   ip address 172.100.100.141/24
   ipv6 enable
   ipv6 address 2001:172:100:100::141/80
   no lldp transmit
   no lldp receive
```
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_as65111-2_Ethernet1 | - | 10.111.0.0/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_as65111-3_Ethernet1 | - | 10.111.0.2/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_CORE1_Ethernet4 | - | 10.0.0.21/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_CORE2_Ethernet24 | - | 10.1.0.49/31 | default | 1500 | False | - | - |

##### IPv6

| Interface | Description | Channel Group | IPv6 Address | VRF | MTU | Shutdown | ND RA Disabled | Managed Config Flag | IPv6 ACL In | IPv6 ACL Out |
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_as65111-2_Ethernet1 | - | - | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_as65111-3_Ethernet1 | - | - | default | 1500 | False | - | - | - | - |
| Ethernet3 | P2P_CORE1_Ethernet4 | - | 2001:db8:0:0:111::1/127 | default | 1500 | False | - | - | - | - |
| Ethernet4 | P2P_CORE2_Ethernet24 | - | 2001:db8:1:0:111:1::1/127 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_as65111-2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.111.0.0/31
   ipv6 enable
   mpls ip
   isis enable CORE
...
!
interface Ethernet2
   description P2P_as65111-3_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.111.0.2/31
   ipv6 enable
   mpls ip
   isis enable CORE
   isis circuit-type level-2
...
!
interface Ethernet3
   description P2P_CORE1_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ip address 10.0.0.21/31
   ipv6 address 2001:db8:0:0:111::1/127
!
interface Ethernet4
   description P2P_CORE2_Ethernet24
   no shutdown
   mtu 1500
   no switchport
   ip address 10.1.0.49/31
   ipv6 address 2001:db8:1:0:111:1::1/127
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.111.1.1/32 |

##### IPv6

| Interface | Description | VRF | IPv6 Address |
| --------- | ----------- | --- | ------------ |
| Loopback0 | ROUTER_ID | default | 2001:db8:111::1/128 |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0101.1100.1001.00 |
| Type | level-2 |
...
!
router isis CORE
   net 49.0001.0101.1100.1001.00
   router-id ipv4 10.111.1.1
   is-type level-2
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.111.1.2 | Inherited from peer group MPLS-OVERLAY-PEERS | default | - | Inherited from peer group MPLS-OVERLAY-PEERS | Inherited from peer group MPLS-OVERLAY-PEERS | - | Inherited from peer group MPLS-OVERLAY-PEERS | - | - | - | - |
...
router bgp 65111
   ...
   neighbor 10.111.1.2 peer group MPLS-OVERLAY-PEERS
   neighbor 10.111.1.2 description as65111-2_Loopback0
