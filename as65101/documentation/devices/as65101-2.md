...
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 2001:172:100:100::102/80 | - |
...
interface Management1
   ...
   ipv6 enable
   ipv6 address 2001:172:100:100::102/80
   no lldp transmit
   no lldp receive
```
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_as65101-1_Ethernet1 | - | 10.101.0.1/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_as65101-3_Ethernet2 | - | 10.101.0.4/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_CORE2_Ethernet4 | - | 10.1.0.1/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_CORE1_Ethernet24 | - | 10.0.0.29/31 | default | 1500 | False | - | - |

##### IPv6

| Interface | Description | Channel Group | IPv6 Address | VRF | MTU | Shutdown | ND RA Disabled | Managed Config Flag | IPv6 ACL In | IPv6 ACL Out |
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_as65101-1_Ethernet1 | - | - | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_as65101-3_Ethernet2 | - | - | default | 1500 | False | - | - | - | - |
| Ethernet3 | P2P_CORE2_Ethernet4 | - | 2001:db8:1:0:101::1/127 | default | 1500 | False | - | - | - | - |
| Ethernet4 | P2P_CORE1_Ethernet24 | - | 2001:db8:0:0:101:1::1/127 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_as65101-1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_as65101-3_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet3
   ...
   ipv6 address 2001:db8:1:0:101::1/127
!
interface Ethernet4
   ...
   ipv6 address 2001:db8:0:0:101:1::1/127
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.101.1.2/32 |

##### IPv6

| Interface | Description | VRF | IPv6 Address |
| --------- | ----------- | --- | ------------ |
| Loopback0 | ROUTER_ID | default | 2001:db8:101::2/128 |
...
interface Loopback0
   ...
   ipv6 address 2001:db8:101::2/128
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0101.0100.1002.00 |
| Type | level-2 |
...
!
router isis CORE
   net 49.0001.0101.0100.1002.00
   router-id ipv4 10.101.1.2
   is-type level-2
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.101.1.1 | Inherited from peer group MPLS-OVERLAY-PEERS | default | - | Inherited from peer group MPLS-OVERLAY-PEERS | Inherited from peer group MPLS-OVERLAY-PEERS | - | Inherited from peer group MPLS-OVERLAY-PEERS | - | - | - | - |
| 10.101.1.3 | Inherited from peer group MPLS-OVERLAY-PEERS | default | - | Inherited from peer group MPLS-OVERLAY-PEERS | Inherited from peer group MPLS-OVERLAY-PEERS | - | Inherited from peer group MPLS-OVERLAY-PEERS | - | - | - | - |
...
router bgp 65101
   ...
   neighbor MPLS-OVERLAY-PEERS remote-as 65101
   neighbor MPLS-OVERLAY-PEERS update-source Loopback0
   neighbor MPLS-OVERLAY-PEERS bfd
   neighbor MPLS-OVERLAY-PEERS password 7 <removed>
   neighbor MPLS-OVERLAY-PEERS send-community
   neighbor MPLS-OVERLAY-PEERS maximum-routes 0
   neighbor 10.101.1.1 peer group MPLS-OVERLAY-PEERS
   neighbor 10.101.1.1 description as65101-1_Loopback0
   neighbor 10.101.1.3 peer group MPLS-OVERLAY-PEERS
   neighbor 10.101.1.3 description as65101-3_Loopback0
   !
   address-family ipv4
