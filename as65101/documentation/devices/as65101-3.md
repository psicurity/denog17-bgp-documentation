...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.103/24 | 172.100.100.1 |

##### IPv6

| Management Interface | Description | Type | VRF | IPv6 Address | IPv6 Gateway |
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 2001:172:100:100::103/80 | - |
...
interface Management1
   ...
   ipv6 enable
   ipv6 address 2001:172:100:100::103/80
   no lldp transmit
   no lldp receive
```
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_as65101-1_Ethernet2 | - | 10.101.0.3/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_as65101-2_Ethernet2 | - | 10.101.0.5/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_as65101-cust_Ethernet1 | - | 10.101.0.14/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_IXP_Ethernet4 | - | 10.10.0.101/24 | default | 1500 | False | - | - |

##### IPv6

| Interface | Description | Channel Group | IPv6 Address | VRF | MTU | Shutdown | ND RA Disabled | Managed Config Flag | IPv6 ACL In | IPv6 ACL Out |
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_as65101-1_Ethernet2 | - | - | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_as65101-2_Ethernet2 | - | - | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_as65101-1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_as65101-2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_as65101-cust_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.101.0.14/31
!
interface Ethernet4
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.101.1.3/32 |

##### IPv6

| Interface | Description | VRF | IPv6 Address |
| --------- | ----------- | --- | ------------ |
| Loopback0 | ROUTER_ID | default | 2001:db8:101::3/128 |
...
interface Loopback0
   ...
   ipv6 address 2001:db8:101::3/128
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0101.0100.1003.00 |
| Type | level-2 |
...
!
router isis CORE
   net 49.0001.0101.0100.1003.00
   router-id ipv4 10.101.1.3
   is-type level-2
